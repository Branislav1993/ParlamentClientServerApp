 ...
 */
public class SOSavePartyMembership extends AbstractSO {

    private AbstractObject partyMembership;
    ...
    public SOSavePartyMembership(AbstractObject partyMembership) {
        this.partyMembership = partyMembership;
    }

    @Override
    protected void executeSpecificOperation() throws SQLException {
        success = DbBroker.getInstance().saveAbstractObject(partyMembership);
    }
